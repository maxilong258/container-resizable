import { ref, computed, onMounted, onUnmounted, defineComponent, openBlock, createElementBlock, normalizeClass, normalizeStyle, createCommentVNode, createElementVNode } from 'vue';
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          ...
          style: normalizeStyle({ width: _ctx.handleWidth + "px" }),
          onMousedown: onMouseDown
        },
        [
          createCommentVNode(" \u62D6\u62FD\u6307\u793A\u5668 "),
          createElementVNode(
            "div",
            {
              class: normalizeClass([
...
export { ResizeHandle, useResizable };
